...
object Ikony {
    ...
    val Naprzod = ikona("naprzod", "M9 5 L16 12 L9 19")

    /** Sekcja, która się rozkłada. Obrócenie o 180° znaczy „złożona”. */
    val Rozwin = ikona("rozwin", "M6 9.5 L12 15.5 L18 9.5")

    /** Zamknięcie panelu albo odrzucenie komunikatu. */
    val Zamknij = ikona("zamknij", "M6.5 6.5 L17.5 17.5 M17.5 6.5 L6.5 17.5")

    /** Akcje, które nie mieszczą się w pasku. Nigdy jedyna droga do akcji. */
    val Wiecej = ikona(
        "wiecej",
        "M12 5.1 A1 1 0 1 0 12 7.1 A1 1 0 1 0 12 5.1 Z M12 11 A1 1 0 1 0 12 13 A1 1 0 1 0 12 11 Z" +
    ...
    val Konto = ikona(
        "konto",
        "M12 3 A9 9 0 1 0 12 21 A9 9 0 1 0 12 3 Z M12 12 A3 3 0 1 0 12 6 A3 3 0 1 0 12 12 Z" +
    ...
    val Szukaj = ikona(
        "szukaj",
        "M10.5 4 A6.5 6.5 0 1 0 10.5 17 A6.5 6.5 0 1 0 10.5 4 M15.5 15.5 L20 20",
    )
    ...
    val Spinacz = ikona(
        "spinacz",
        "M17 8.5 L10 15.5 A2.5 2.5 0 0 0 13.5 19 L20 12.5 A5 5 0 0 0 13 5.5 L6.5 12" +
    ...
    val Zdjecie = ikona(
        "zdjecie",
        "M3.5 5.5 H20.5 V18.5 H3.5 Z M3.5 15.5 L8.5 10.5 L13 15 M12.5 15.5 L15.5 12.5 L20.5 17" +
        " M15.8 8 A1.3 1.3 0 1 0 15.8 10.6 A1.3 1.3 0 1 0 15.8 8 Z",
    )

    /** Załącznik będący nagraniem. */
    val Film = ikona("film", "M3.5 6 H20.5 V18 H3.5 Z M8 6 V18 M16 6 V18 M3.5 12 H8 M16 12 H20.5")

    /** Załącznik, którego nie umiemy pokazać w rozmowie. */
    val Plik = ikona("plik", "M6 3.5 H14 L18 7.5 V20.5 H6 Z M14 3.5 V7.5 H18")

    /** Pobranie załącznika na urządzenie — dopiero wtedy opuszcza on aplikację. */
    val Pobierz = ikona("pobierz", "M12 4 V15 M7.5 10.5 L12 15 L16.5 10.5 M5 19 H19")

    /** Skopiowanie kodu albo nazwy do schowka. */
    val Kopiuj = ikona("kopiuj", "M8.5 8.5 H19.5 V19.5 H8.5 Z M15.5 8.5 V4.5 H4.5 V15.5 H8.5")

    /** Skasowanie nieodwracalne. Historii nie ma nigdzie indziej. */
    val Kosz = ikona(
        "kosz",
        "M4.5 7 H19.5 M9.5 7 V4.5 H14.5 V7 M6.5 7 L7.5 20 H16.5 L17.5 7 M10 10.5 V16.5" +
        " M14 10.5 V16.5",
    )
    ...
    val Zegar = ikona(
        "zegar",
        "M12 3.5 A8.5 8.5 0 1 0 12 20.5 A8.5 8.5 0 1 0 12 3.5 Z M12 7.5 V12.2 L15.5 14.2",
    )

    /** Wiadomość opuściła urządzenie. */
    val Wyslane = ikona("wyslane", "M5 12.5 L9.5 17 L19 6.5")

    /** Wiadomość leży w skrzynce odbiorcy. Nie znaczy „przeczytana” — tego serwer nie wie. */
    val Dostarczone = ikona("dostarczone", "M3 12.5 L7 16.5 L15 6.5 M11 15.5 L12.5 17 L21 6.5")

    /** Wysyłka się nie udała. Treść nie przepada — zawiodła sieć, nie użytkownik. */
    val Niepowodzenie = ikona(
        "niepowodzenie",
        "M12 3.5 A8.5 8.5 0 1 0 12 20.5 A8.5 8.5 0 1 0 12 3.5 Z M12 7.5 V13 M12 16.3 V16.5",
    )
    ...
    val Rozlacz = ikona(
        "rozlacz",
        "M3.5 15 A12 12 0 0 1 20.5 15 L18 17.5 L14.6 15.3 V12.6 A9 9 0 0 0 9.4 12.6 V15.3" +
        " L6 17.5 Z",
    )
    ...
    val KameraWylaczona = ikona(
        "kameraWylaczona",
        "M3.5 7 H14 V17 H3.5 Z M14 11 L20.5 7.5 V16.5 L14 13 Z M4 4 L20 20",
    )
    ...
    val Glosnik = ikona(
        "glosnik",
        "M4 9.5 H7.5 L12 5.5 V18.5 L7.5 14.5 H4 Z M15 9.8 A4 4 0 0 1 15 14.2" +
    ...
    val Klucz = ikona(
        "klucz",
        "M14.5 5.5 A4 4 0 1 1 11 12.2 L10 13.2 H8 V15.2 H6 V17.2 H3.5 V14.7 L10 8.2" +
    ...
    val Odcisk = ikona(
        "odcisk",
        "M12 4 A8 8 0 0 0 4 12 M12 4 A8 8 0 0 1 20 12 M7.5 12 A4.5 4.5 0 0 1 16.5 12 V15" +
    ...
    val Ostrzezenie = ikona("ostrzezenie", "M12 4 L21 19.5 H3 Z M12 9.5 V14 M12 16.8 V17")

    /** Wyjaśnienie tego, co dzieje się z danymi. Nie wymaga reakcji. */
    val Info = ikona(
        "info",
        "M12 3.5 A8.5 8.5 0 1 0 12 20.5 A8.5 8.5 0 1 0 12 3.5 Z M12 11 V16.5 M12 7.4 V7.6",
    )

    /** Usunięcie konta z tego urządzenia. Razem z nim znika historia. */
    val Wyloguj = ikona(
        "wyloguj",
        "M15 8 V5 H4.5 V19 H15 V16 M9.5 12 H20.5 M17.5 9 L20.5 12 L17.5 15",
    )
    ...
    val Odswiez = ikona("odswiez", "M18.4 18.4 A9 9 0 1 1 18.4 5.6 M16.4 9.6 H21 V5")

    /** Powiadomienia. */
    val Dzwonek = ikona("dzwonek", "M6 17 V11 A6 6 0 0 1 18 11 V17 H19.5 H4.5 Z M10 20 H14")

    /** Motyw jasny. */
    val Slonce = ikona(
        "slonce",
        "M12 8 A4 4 0 1 0 12 16 A4 4 0 1 0 12 8 Z M12 3.2 V5.2 M12 18.8 V20.8 M3.2 12 H5.2" +
        " M18.8 12 H20.8 M5.8 5.8 L7.2 7.2 M16.8 16.8 L18.2 18.2 M18.2 5.8 L16.8 7.2" +
        " M7.2 16.8 L5.8 18.2",
    )

    /** Motyw ciemny — domyślny w tym systemie. */
    val Ksiezyc = ikona("ksiezyc", "M20.2 14.6 A8.6 8.6 0 1 1 9.4 3.8 A7 7 0 0 0 20.2 14.6 Z")

    /** Motyw zgodny z ustawieniem systemu. */
    val Ekran = ikona("ekran", "M3.5 5 H20.5 V16 H3.5 Z M9 20 H15 M12 16 V20")
}
